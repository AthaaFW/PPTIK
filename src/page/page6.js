...
import img from '../asset/WhatsApp-Image-2023-03-04-at-08.57.13-520x245.jpeg'
        ...
        <div className="flex flex-col items-center space-y-[30px] pt-[70px] overflow-x-hidden" id="home">
            ...
            <div className="w-[65%] flex flex-col space-y-[15px] items-center">
                <div className="flex flex-col space-y-[2px] w-full border-b-[1px] border-gray-600 pb-[10px]">
                    <h1 className="text-gray-600 text-2xl">Kunjugan dari SMKN 1 Dauwan</h1>
                    <h1 className="text-gray-500 text-base">01 Maret 2023</h1>
                </div>
                <img src={img} alt="" />
                <div className="w-full text-gray-700 pt-[10px]">
                    <p>
                        Pada tanggal 01 Maret 2023 SMKN 1 Dauwan berkunjung ke PPTIK untuk membahas teknologi yang berkaitan dengan pendidikan.
                    </p>
                </div>
            </div>
            <Footer/>   
